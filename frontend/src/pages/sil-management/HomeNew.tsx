...
const HomeNew: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Creating new home:', formData);
    // Navigate to the new home's profile page
    navigate('/sil/homes/1'); // Replace with actual ID from API response
  };
      ...
      <div className="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Add New SIL Home</h1>
            <p className="mt-2 text-gray-600">Register a new Supported Independent Living property</p>
          </div>
