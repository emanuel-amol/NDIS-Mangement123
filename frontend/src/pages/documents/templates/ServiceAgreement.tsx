...
type PricingItem = { name: string; rate: number; hours: number };
type Props = {
...
export default function ServiceAgreement(props: Props) {
    ...
    <html>
      ...
      <body>
        ...
        <table>
          ...
          <tfoot>
            <tr><th colSpan={3} style={{ textAlign:"right" }}>Grand Total</th><th>{total.toFixed(2)}</th></tr>
          </tfoot>
        </table>
